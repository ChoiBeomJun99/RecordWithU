...
import com.example.rwu2.databinding.PlandownloadBinding
...
class PlanDownloadDialog(loc: LatLng) : DialogFragment() {
    lateinit var binding:PlandownloadBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
        ...
        binding = PlandownloadBinding.inflate(inflater, container, false)
        ...
        binding.apply {
                    ...
                    override fun onDataChange(snapshot: DataSnapshot) {
                        ...
                        for(FB in FBarray){
                            if(FB.lat.toString()==lat.toString() && FB.lng.toString()==lng.toString()){
                                posText2.text = FB.title
                                memoText2.text = FB.text
                                dateText2.text = FB.date
                            }
                            else{
                                Log.i("error!","error!")
                            }
            ...
            posButton2.setOnClickListener{
                posText2.visibility = View.VISIBLE
                memoText2.visibility = View.GONE
                dateText2.visibility = View.GONE
            }
            memoButton2.setOnClickListener{
                posText2.visibility = View.GONE
                memoText2.visibility = View.VISIBLE
                dateText2.visibility = View.GONE
            }
            calButton2.setOnClickListener{
                posText2.visibility = View.GONE
                memoText2.visibility = View.GONE
                dateText2.visibility = View.VISIBLE
            }
        }
